...
*/
Textbook::Textbook(): subject_{""}, grade_level_{NONE}, has_review_questions_{false}
{    
}
...
*/
Textbook::Textbook(const std::string& name, const std::string& author, int page_count, const std::string& subject, bool is_digital, grade_level grade, bool has_review):Book(name, author, page_count, is_digital), subject_{subject}, grade_level_{grade}, has_review_questions_{has_review}{
}
