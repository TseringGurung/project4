...
/**
 * @struct 'review' : {double score_, string rating_}
*/
struct review {
    double score_;
    std::string rating_;
...
class Novel : public Book {
    private:
        ...
        std::vector<std::string> characters_;  // a vector of strings storing the characters in the novel (a character list)
        ...
        double avg_rating_;                    // a floating point number (double) storing the average rating
